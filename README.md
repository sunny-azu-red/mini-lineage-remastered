...
- **The Fallen May Look Back**: Death keeps everything but health and effects, so a dead character can still open its own Character screen — marked by ☠️ rather than its ancestry and written in the past. Where the living are told what walks with them, the fallen are told that nothing does any more and how the road ran out — voiced for whoever is reading, so a stranger's record never addresses them as *you*. The dead may also reach the Halls, where their run already stands.
