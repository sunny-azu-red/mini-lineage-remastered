defmodule MiniLineage.Game.Constants do
  ...
  @races [
    %{
      id: 0, label: "Human", plural: "Humans", emoji: "🧙", enemy_race_id: 1,
      start_health: 100, start_adena: 300, ambush_chance: 8, regen: 1, crit: 4,
      backstory:
    ...
    %{
      id: 1, label: "Orc", plural: "Orcs", emoji: "🧟", enemy_race_id: 0,
      start_health: 150, start_adena: 250, ambush_chance: 16, regen: 0, crit: 0,
      backstory:
    ...
    %{
      id: 2, label: "Elf", plural: "Elves", emoji: "🧝", enemy_race_id: 3,
      start_health: 75, start_adena: 450, ambush_chance: 4, regen: 3, crit: 8,
      backstory:
    ...
    %{
      id: 3, label: "Dark Elf", plural: "Dark Elves", emoji: "🧛", enemy_race_id: 2,
      start_health: 85, start_adena: 350, ambush_chance: 5, regen: 2, crit: 11,
      backstory:
  ...
  @effects %{
    ...
    regen_aura: %{id: "regenerating", type: :aura, emoji: "🌿", label: "Regenerating", modifiers: []},
    newbie_buff: %{
      id: "newbie_blessing", type: :buff, emoji: "🐣", label: "Newbie Blessing", duration_ms: 300_000,
      modifiers: [%{type: :max_health, value: 20}, %{type: :defense, value: 2}, %{type: :ambush_risk, value: -4}]
    },
    ambush_debuff: %{
      id: "hexed", type: :debuff, emoji: "👁️", label: "Hexed", duration_ms: 60_000,
      modifiers: [%{type: :ambush_risk, value: 4}, %{type: :crit, value: -2}]
    },
    konami_cheat: %{
      id: "konami_cheat", type: :debuff, emoji: "👾", label: "Cheater's Mark",
      modifiers: [
        %{type: :xp_multiplier, value: 4}, %{type: :adena_multiplier, value: 4},
        %{type: :crit, value: 15}, %{type: :max_health, value: 150}
      ]
    },
    smoked_sausage: %{
      id: "satisfied", type: :buff, group: "food", emoji: "🥓", label: "Satisfied",
      duration_ms: 90_000, modifiers: [%{type: :max_health, value: 10}]
    },
    hearty_mash: %{
      id: "well_fed", type: :buff, group: "food", emoji: "🍖", label: "Well Fed",
      duration_ms: 150_000, modifiers: [%{type: :max_health, value: 30}]
    },
    roasted_pheasant: %{
      id: "gourmet_feast", type: :buff, group: "food", emoji: "👑", label: "Gourmet Feast",
      duration_ms: 300_000, modifiers: [%{type: :max_health, value: 60}]
    }
  }
  ...
  @foods [
    ...
    %{id: 4, name: "Roasted Pheasant", emoji: "🍗", stat: 65, cost: 1_200, effect: :roasted_pheasant}
  ]
  ...
  @character %{
    min_age: 9, max_age: 69,
    age_thresholds: %{youth: 23, adult: 54, labels: %{youth: "youth", adult: "adult", elder: "elder"}},
    name_min_length: 1, name_max_length: 20,
