defmodule MiniLineage.Game.JsParityTest do
  ...
  @damage_blocked [{0, 1}, {1, 1}, {2, 1}, {10, 7}, {22, 15}, {41, 27}, {64, 41}, {88, 56}, {150, 93}, {999, 565}]
  @base_xp [{0, 0}, {1, 0}, {7, 14}, {16, 51}, {28, 118}, {45, 241}, {62, 390}, {90, 683}, {150, 1469}, {999, 25260}]
  @base_adena [{0, 0}, {1, 0}, {7, 8}, {16, 77}, {28, 341}, {45, 1202}, {62, 2810}, {90, 7545}, {150, 29215}, {999, 4_444_455}]
  @xp_for_level [{1, 0}, {2, 780}, {3, 1560}, {10, 14300}, {25, 84500}, {50, 331_500}, {79, 821_600}, {80, 842_400}]

  @numbers [{0, "0"}, {1, "1"}, {999, "999"}, {1000, "1,000"}, {1234, "1,234"}, {999_999, "999,999"},
            {1_000_000, "1,000,000"}, {123_456_789, "123,456,789"}, {-4567, "-4,567"}]

  @adenas [{0, "0"}, {7, "7"}, {999, "999"}, {1000, "1k"}, {1050, "1k"}, {1500, "1.5k"},
           {9999, "9.9k"}, {999_999, "999.9k"}, {1_000_000, "1kk"}, {2_500_000, "2.5kk"},
           {1_234_567_890, "1.2kkk"}, {-1500, "-1.5k"}]

  test "damage_blocked matches Math.pow(d, 0.95) * 0.8, floored" do
    for {defense, expected} <- @damage_blocked, do: assert(Math.damage_blocked(defense) == expected)
  end
